...
import xyz.yhhit.OmnipotentTools.Modules.test2.DataSheet.VaSht;
...
import static xyz.yhhit.OmnipotentTools.Modules.test2.Utils.OLogger.logDebug;
...
public class Modules {
    ...
    //将参数按照空格分割
    public static String[] splitArg(String str){
        return str.split("[\\s]+");
    }
